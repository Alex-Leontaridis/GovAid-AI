...
const Logos3 = ({
  heading = "Analyzing Policies from America's Most Trusted Agencies",
  logos = [
    {
      id: "logo-1",
      description: "Government Agency 1",
      image: "/gov_logos/logo.png",
      className: "h-8 w-auto",
    },
    {
      id: "logo-2",
      description: "Government Agency 2",
      image: "/gov_logos/logo2.png",
      className: "h-8 w-auto",
    },
    {
      id: "logo-3",
      description: "Government Agency 3",
      image: "/gov_logos/logo3.png",
      className: "h-8 w-auto",
    },
    {
      id: "logo-5",
      description: "Government Agency 5",
      image: "/gov_logos/logo5.png",
      className: "h-8 w-auto",
    },
    {
      id: "logo-6",
      description: "Government Agency 6",
      image: "/gov_logos/logo6.png",
      className: "h-8 w-auto",
    },
    {
      id: "logo-7",
      description: "Government Agency 7",
      image: "/gov_logos/logo7.png",
      className: "h-8 w-auto",
    },
    {
      id: "logo-8",
      description: "Government Agency 8",
