        ...
        <div className="max-w-4xl mx-auto">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3 text-sm text-gray-600">
                    <p>
                      ...
                      and eligibility requirements extracted from the original government aid policy document.
                    </p>
                    <p>
                      For interactive features like asking questions about this government aid policy, visit our main platform.
                    </p>
                  </div>
                </CardContent>
              </Card>
          ...
          <div className="text-center mt-12 pt-8 border-t border-gray-200">
            <p className="text-gray-500 text-sm">
              Generated by GovAid-AI - Making government aid policies accessible to everyone
            </p>
            <div className="mt-4">
              <Button variant="outline" size="sm" asChild>
                <Link to="/upload" className="flex items-center gap-2">
                  <Upload className="h-4 w-4" />
                  Analyze Your Own Government Aid Policy
                </Link>
              </Button>
            </div>
          </div>
