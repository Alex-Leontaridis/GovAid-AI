...
export class PDFGenerator {
  ...
  static async generateAnalysisPDF(
    ...
    const {
      ...
      documentTitle = 'Government Aid Policy Document Analysis',
    ...
    container.innerHTML = `
      ...
      <div style="margin-bottom: 30px;">
        <h2 style="color: #1f2937; font-size: 20px; margin-bottom: 15px; border-bottom: 2px solid #e5e7eb; padding-bottom: 5px;">
          ✅ Government Aid Eligibility Requirements
        </h2>
        ...
        <div style="margin-bottom: 30px;">
          ...
          <div style="background-color: #f8fafc; padding: 20px; border-radius: 8px;">
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px;">
              ...
              <div>
                <strong>Eligibility Requirements Found:</strong> ${analysisResult.metadata.checklistCount} items
              </div>
            </div>
          </div>
        </div>
      ...
      <div style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #e5e7eb; text-align: center; color: #6b7280; font-size: 12px;">
        <p>Generated by GovAid-AI - Making government aid policies accessible to everyone</p>
  ...
  static downloadPDF(blob: Blob, filename: string = 'government-aid-policy-analysis.pdf'): void {
